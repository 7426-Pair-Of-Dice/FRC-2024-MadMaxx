...
public class SwerveConstants {
    ...
    public static final double kMaxSpeed = 4.724 * 1.0;
    
    /** How fast the wheels on the swerve modules turn in radians per second */
    public static final double kMaxAngularRate = 4.0 * Math.PI;
    
    /** The allowable deadband on the swerve */
    ...
    public static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(125).withKI(0).withKD(0.2)
        .withKS(0).withKV(1.5).withKA(0);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    public static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.225/*3*/).withKI(0).withKD(0.003)
        .withKS(0.0).withKV(0.105).withKA(0);
    ...
    private static final double kSlipCurrentA = 72.5; // Ignored
